...
public class HubScreen extends BaseOwoScreen<FlowLayout> {
    ...
    boolean eventFormInstant      = false;
    ...
    private void buildHeader(FlowLayout root) {
        ...
        int rightWrapW  = creditPx + 8 + 46 + 8 + 20;
        ...
        rightWrap.child(styledBtn(46, 20, Text.literal("⬡ HUD").withColor(0xFFAABBFF),
                0xFF0A1020, 0xFF152030,
    ...
    public static void refreshEventsIfOpen() {
        MinecraftClient mc = MinecraftClient.getInstance();
        if (mc.currentScreen instanceof HubScreen hub && hub.activeTab == Tab.EVENTS) {
            hub.eventsTab.updateCountdowns();
        }
    }
}