...
public class WavelengthConfig {
    ...
    public int topBarOffsetX    = 0;
    public int topBarOffsetY    = 0;

    public int playersHudOffsetX = 0;
    public int playersHudOffsetY = 0;

    public int eventsHudOffsetX = 0;
    public int eventsHudOffsetY = 0;
    ...
    public boolean muteAllChatMessages   = false;
    ...
    public static Screen buildScreen(Screen parent) {
        ...
        return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .option(Option.<Boolean>createBuilder()
                                .name(Text.literal("Mute All Chat Messages"))
                                .description(OptionDescription.of(Text.literal(
                                        "Suppresses every chat message the mod sends — friend requests, "
                                                + "project notifications, event announcements, everything.\n"
                                                + "Useful on busy servers where the mod would otherwise spam chat.")))
                                .binding(false, () -> cfg.muteAllChatMessages, v -> cfg.muteAllChatMessages = v)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
