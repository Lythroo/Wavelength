...
public final class ServerFriendData {
    ...
    private static void save() {
        ...
        try (Writer w = new FileWriter(tmp.toFile())) {
            ...
            Wavelength.LOGGER.warn("[Wavelength] Failed to write friend data tmp: {}", e.getMessage());
            return;
        }
        try {
            ...
            Wavelength.LOGGER.warn("[Wavelength] Failed to atomically replace friend data: {}", e.getMessage());
        }
    }
